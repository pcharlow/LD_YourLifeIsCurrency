...
onready var timer : Timer = Timer.new() # Timer for how long to stay at a point
...
func makePath() -> void:
	...
	path = NavNode.get_simple_path(global_position, possible[index].global_position, false)
